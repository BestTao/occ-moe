...
name = f'ViT-T-21k_pt-EXP_[{c_EXPs},{u_EXPs}]-slots_{n_slots}-dp_{dp}-moedr_{moe_dr}-moedpr_{moe_dp}-Nmoe_{moe_layers}-{total_batch}_{accumulative_counts}_{n_GPU}-lr_{lr}-decay_{layer_decay_rate}-softmax+entmax15'  # -noise-ld
load_from = f'moejet/weights/gen_weight/Dual-MoE-L2-mlp-[{c_EXPs}, {u_EXPs}]-{moe_layers}_[D_vit_t]+[E_vit_s+univ_t]_selected.pt'
moe_mult = 1.0
